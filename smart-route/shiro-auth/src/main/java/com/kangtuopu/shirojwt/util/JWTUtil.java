package com.kangtuopu.shirojwt.util;
...
public class JWTUtil {
    ...
    public static void main(String[] args) throws IllegalArgumentException, UnsupportedEncodingException {
            ...
            map.put("permission", "/user,POST,GET,PUT,DELETE");
            
            // 附带username信息
            String jwttoken = JWT.create()
                    .withClaim("username", map.toString())
                    //到期时间
                    .withExpiresAt(date)
                    //创建一个新的JWT，并使用给定的算法进行标记
                    .sign(algorithm);
            ...
            String userinfo = jwt.getClaim("username").asString();
